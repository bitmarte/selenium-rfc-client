...
public interface I_ElementExtractor {
     ...
     *
     * @param driver    {@link WebDriver} implementation
     * @param str       element identifier {@link String}
     * @param condition null if you don't have a condition
     * @return
     */
    ...
    /**
     * Extract the {@link WebElement} based on content and, optionally a
     * {@link A_TestCondition} as configuration, no wait, no polling
     *
     * @param driver    {@link WebDriver} implementation
     * @param str       element identifier {@link String}
     * @param condition null if you don't have a condition
